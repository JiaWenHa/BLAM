...
if(NOT "/home/ros/blam_ws/src/blam/internal/src/point_cloud_visualizer/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(point_cloud_visualizer_INCLUDE_DIRS "")
  set(_include_dirs "/home/ros/blam_ws/src/blam/internal/src/point_cloud_visualizer/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'point_cloud_visualizer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/blam_ws/src/blam/internal/src/point_cloud_visualizer/${idir}'.  ${_report}")
    endif()
